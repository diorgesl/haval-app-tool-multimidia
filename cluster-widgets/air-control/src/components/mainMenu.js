...
export const menuItems = [
    ...
    { id: 'option_2', label: 'Perfis', iconSrc: iconProfiles },
    { id: 'option_3', label: 'Menu A/C', iconSrc: iconAC },
    { id: 'option_4', label: 'Modo', iconSrc: iconMode },
    { id: 'option_5', label: 'Conforto', iconSrc: iconSteer },
    { id: 'option_6', label: 'Regen. Normal', iconSrc: iconRegen },
];
